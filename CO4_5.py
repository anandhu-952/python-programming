# Q5. Create a class Publisher(name). Derive class Book(title, author). Derive class Python(price, no_of_pages). Display Python book info using constructor invocation and method overriding.
